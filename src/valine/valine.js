...
const prediction = require('../../predictions/valine.json');
const settings = require('../valine/settings.json');
const spectra = require('../../spectra/valine.json');
...
fs.appendFileSync(
  `../results/valine-${predicted.iterations}.json`,
