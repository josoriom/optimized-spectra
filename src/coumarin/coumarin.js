...
const prediction = require('../../predictions/coumarin.json');
const settings = require('../coumarin/settings.json');
const spectra = require('../../spectra/coumarin.json');
...
fs.appendFileSync(
  `../results/coumarin-${predicted.iterations}.json`,
