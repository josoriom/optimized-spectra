...
const prediction = require('../../predictions/serotonin.json');
const settings = require('../serotonin/settings.json');
const spectra = require('../../spectra/serotonin.json');
...
fs.appendFileSync(
  `../results/serotonin-${predicted.iterations}.json`,
